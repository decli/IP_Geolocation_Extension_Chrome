...
![IP Address & Geolocation 设置页：IPv4 / IPv6 地址变化通知两个开关、国家指示来源的 Auto / IPv4 / IPv6 三选一、是否显示国旗、是否显示国家代码徽标，底部是保存按钮](docs/images/extension-options.jpg)

设置页只有五项：两个变化通知开关、国家指示取哪一个地址族，以及工具栏上显示国旗还是国家代码徽标。

## 功能

- 工具栏直接显示出口国家代码和国旗，鼠标悬停显示当前 IP、归属地与数据来源；弹窗面板同样标注该读数来自海外接口还是大陆直连接口。
